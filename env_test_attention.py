...
from dynamicmap import MapEnvironment, DynamicMap, AttentionEnvironment
...
if __name__ == '__main__':
    ...
    def make_env():
        ...
        return MapEnvironment(map, glimpse_pi, 84, 21, args.device)
        # return None
    ...
    callbacks = [callbacks.PrintCallback(freq=1),
                 callbacks.SaveNetworks(
                     save_dir='/home/himanshu/experiments/DynamicNeuralMap/PhysEnv/RL_DMM_envdata',
                     freq=10,
